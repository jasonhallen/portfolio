...
* [Courtesy Notice](https://github.com/jasonhallen/portfolio/blob/main/courtesy_notice.xslt) - This an example of one such notice.  I've annotated my customizations in the code.
* [Loan Receipt Notice](LINK)
